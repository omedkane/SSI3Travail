...
public class RowTest
{
    ...
    public void UpdatePropWithVal()
    {
        ...
        Assert.IsTrue(Row.Record.FirstName == "Oumar" && Row.Record.LastName == "Kane");

        Assert.ThrowsException<PrimaryKeyException>(() => Row.Update("ID", new Guid()));
    }
    ...
    public void UpdateWithAction()
    {
        ...
        Assert.AreEqual(Row.Record.Email, newEmail);
    }
}
