...
public class TableTest
{
    ...
    public void Insert()
    {
        ...
        Assert.AreEqual(users.GetAll().Count, 2);
        Assert.AreEqual(users.GetAll().Last().Record.FirstName, "Ronaldinho");
    }
    ...
    public void Find()
    {
        ...
        Assert.AreSame(users.Find(testSubject.ID).Record, testSubject);
    }
    ...
    public void FindAll()
    {
        ...
        Assert.IsTrue(queryResult.Found.Count == 3 && queryResult.NotFound.Count == 2);
    }
    ...
    public void FindWhere()
    {
        ...
        List<Row<User>> mikaelsons = users.FindWhere(user => user.LastName == "Mikaelson");
    ...
    public void UpdateAll()
    {
        ...
        users.UpdateAll(
            salvatoreIDs,
            user => user.Email = user.Email.Replace("mfalls", "virginia")
        );

        Assert.IsTrue(salvatores.All(row => row.Record.Email.Contains("virginia")));
    }
    ...
    public void UpdateWhere()
    {
        ...
        users.UpdateWhere(user => user.LastName == "Mikaelson", user => user.LastName = "Michels");
    ...
    public void Remove()
    {
        ...
        Assert.AreEqual(users.GetAll().Count, 1);

        Assert.AreNotSame(users.GetAll().First().Record, testSubject);
    }
    ...
    public void RemoveWhere()
    {
        ...
        Assert.AreEqual(users.Count, initialCount - salvatores.Count);
    }
}
